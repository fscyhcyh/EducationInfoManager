...
import com.itheimalearn.edumanager.service.TeacherServiceImpl;

import java.util.Scanner;

public class TeacherControllerImpl implements Controller {
    Scanner sc = new Scanner(System.in);
    BaseService service = new TeacherServiceImpl();
    ...
    @Override
    public void findAll() {
        Person[] teachers = service.findAll();
